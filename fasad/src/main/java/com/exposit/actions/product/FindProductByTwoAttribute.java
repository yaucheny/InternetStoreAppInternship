...
@Log4j
public class FindProductByTwoAttribute extends AbstractAction implements IAction {
    @Override
    public void execute() {
        try {
            ...
            System.out.println(fasade.findByTwoAttribute(value1, attribute1, value2, attribute2));
        } catch (Exception e) {
