...
public class ShopProductController {
    ...
    @PostMapping(value = "/")
    public ResponseEntity<String> save(@RequestBody ShopProductDto shopProductDto) {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<String> update(@PathVariable Long id, @RequestBody ShopProductDto shopProductDto) {
