...
public class DeleteCustomerImpl extends AbstractAction implements Action {

    private static final Logger LOG = LoggerFactory.getLogger(DeleteCustomerImpl.class);
