...
public class SaveToFileCustomer extends AbstractAction        implements IAction {

    private static final Logger LOG = LoggerFactory.getLogger(SaveToFileCustomer.class);
