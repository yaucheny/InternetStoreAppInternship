...
public class UpdateOrderImpl extends AbstractAction implements Action {

    private static final Logger LOG = LoggerFactory.getLogger(UpdateOrderImpl.class);
    ...
    public void execute() {
        try {
            ...
            facade.updateOrder(orderId, orderDto);
            System.out.println("order id :" + orderId + " updated");
        } catch (Exception e) {
            LOG.error("can not update order");
        }
    }
}
